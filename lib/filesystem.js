    ...
    process.nextTick(() => {
      ...
      if (_windows) {
        ...
        try {
          ...
          const workload = [];
          workload.push(util.powerShell('Get-CimInstance -ClassName Win32_volume | select Caption,DriveType,Name,FileSystem,Size,FreeSpace,SerialNumber, Label, Automount | fl'));
